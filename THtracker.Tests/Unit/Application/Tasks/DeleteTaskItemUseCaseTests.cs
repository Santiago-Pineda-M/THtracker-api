...
public class DeleteTaskItemUseCaseTests
{
    private readonly Mock<ITaskRepository> repositoryMock;
    private readonly Mock<IUnitOfWork> unitOfWorkMock;
    private readonly DeleteTaskItemUseCase useCase;

    public DeleteTaskItemUseCaseTests()
    {
        this.repositoryMock = new Mock<ITaskRepository>();
        this.unitOfWorkMock = new Mock<IUnitOfWork>();
        this.useCase = new DeleteTaskItemUseCase(
    ...
    [Fact]
    public async Task ExecuteAsync_ShouldDeleteTask_WhenUserOwnsTask()
    {
        // Arrange
        ...
        this.repositoryMock.Setup(x => x.GetByIdAsync(task.Id, It.IsAny<CancellationToken>()))
            .ReturnsAsync(task);
        this.repositoryMock.Setup(x => x.DeleteAsync(task.Id, It.IsAny<CancellationToken>()))
            .ReturnsAsync(true);
