...
public sealed class UpdateValueDefinitionCommandHandler : IRequestHandler<UpdateValueDefinitionCommand, Result<ActivityValueDefinitionResponse>>
{
    private readonly IActivityValueDefinitionRepository _definitionRepository;
    private readonly IActivityRepository _activityRepository;
    private readonly IUnitOfWork _unitOfWork;

    public UpdateValueDefinitionCommandHandler(
    ...
    public async Task<Result<ActivityValueDefinitionResponse>> Handle(UpdateValueDefinitionCommand request, CancellationToken cancellationToken)
    {
